...
class Test_DataStores(unittest.TestCase):
    ...
    def do_test(self, data_store):
        ...
        admin_role_obj = AnodeObject('UserRole', admin_role)
        ...
        data_provider_role_obj = AnodeObject('UserRole', data_provider_role)
        ...
        marine_operator_role_obj = AnodeObject('UserRole', marine_operator_role)
        ...
        hvl_user_info_obj = AnodeObject('UserInfo', hvl_user_info)
        ...
        ats_user_info_obj = AnodeObject('UserInfo', ats_user_info)
        ...
        pok_user_info_obj = AnodeObject('UserInfo', pok_user_info)
