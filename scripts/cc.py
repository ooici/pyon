...
from anode.base import Container, GreenProcessSupervisor
...
description = '''
anode (ION capability container) v%s
''' % (version)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--version', action='version', version='anode v%s' % (version))
